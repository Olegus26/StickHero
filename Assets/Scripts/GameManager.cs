...
public class GameManager : MonoBehaviour
{
    ...
    private void SetRandomSize(GameObject pillar)
    {
    ...
    private IEnumerator Move(Transform currentTransform,Vector3 target,float time)
    {
        var passed = 0f;
    ...
    private IEnumerator Rotate(Transform currentTransform, Transform target, float time)
    {
        var passed = 0f;
